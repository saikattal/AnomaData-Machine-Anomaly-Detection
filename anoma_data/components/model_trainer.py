...
from anoma_data.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from anoma_data.entity.config_entity import ModelTrainerConfig
from anoma_data.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            usvisa_model = AnomaDataModel(preprocessing_object=preprocessing_obj,
