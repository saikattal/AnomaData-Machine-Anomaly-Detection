...
DATABASE_NAME = 'AnomaData'

COLLECTION_NAME = 'anomaly_data'

MONGODB_URL_KEY = os.getenv("MONGODB_URL")

PIPELINE_NAME: str = "anoma_data"
...
"""
DATA_INGESTION_COLLECTION_NAME: str = "anomaly_data"
...
MODEL_BUCKET_NAME = "anomadata-model2024"
